...
export const kiteWidth       = document.getElementById('kiteWidth');
export const kiteTop         = document.getElementById('kiteTop');
export const kiteBottom      = document.getElementById('kiteBottom');
